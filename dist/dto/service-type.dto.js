...
exports.PaginatedServiceTypesDto = exports.ServiceTypeResponseDto = exports.UpdateServiceTypeDto = exports.CreateServiceTypeDto = void 0;
const enums_1 = require("../generated/prisma/enums");
const VALID_CATEGORIES = Object.values(enums_1.ServiceCategory);
...
class UpdateServiceTypeDto {
    ...
    static sanitize(data) {
        ...
        if (data.fee !== undefined)
            dto.fee = Number(data.fee);
        if (data.duration !== undefined)
            dto.duration = Number(data.duration);
        if (data.requiresAppointment !== undefined)
            dto.requiresAppointment = data.requiresAppointment;
        return dto;
    }
}
...
exports.ServiceTypeResponseDto = ServiceTypeResponseDto;
class PaginatedServiceTypesDto {
}
exports.PaginatedServiceTypesDto = PaginatedServiceTypesDto;
