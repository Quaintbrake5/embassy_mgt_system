...
describe('AuditService', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        auditService = new audit_service_1.AuditService(mockPrisma);
    });
    describe('log', () => {
    ...
    describe('exportLogs', () => {
        it('should export all matching logs without pagination', async () => {
            ...
            expect(mockPrisma.auditLog.findMany).toHaveBeenCalledWith(expect.not.objectContaining({ skip: expect.any(Number), take: expect.any(Number) }));
        });
    });
    describe('purgeOldLogs', () => {
        it('should delete logs older than default 7-year retention', async () => {
            ...
            expect(mockPrisma.auditLog.deleteMany).toHaveBeenCalledWith(expect.objectContaining({
