...
exports.mockCryptoUtilities = exports.mockBcryptUtilities = exports.mockJwtUtilities = void 0;
exports.createMockUser = createMockUser;
exports.createMockRole = createMockRole;
exports.createMockPermission = createMockPermission;
exports.createMockRefreshToken = createMockRefreshToken;
exports.createMockAuditLog = createMockAuditLog;
exports.createMockEmbassy = createMockEmbassy;
exports.createMockDepartment = createMockDepartment;
exports.createMockServiceType = createMockServiceType;
exports.createMockServiceRequest = createMockServiceRequest;
exports.createMockVisaApplication = createMockVisaApplication;
exports.createMockPayment = createMockPayment;
exports.createMockEmergencyCase = createMockEmergencyCase;
exports.createMockDiplomaticPouch = createMockDiplomaticPouch;
exports.createMockAppointment = createMockAppointment;
exports.createMockWatchlistEntry = createMockWatchlistEntry;
exports.createMockVerificationCheck = createMockVerificationCheck;
...
function createMockPermission(overrides = {}) {
    return {
        id: 'perm-1',
        name: 'Read Users',
        slug: 'user:read',
...
function createMockRefreshToken(overrides = {}) {
    return {
        id: 'rt-1',
...
function createMockEmbassy(overrides = {}) {
    return {
        id: 'embassy-1',
        name: 'Test Embassy',
        code: 'TEST',
...
function createMockServiceRequest(overrides = {}) {
    return {
        id: 'sr-1',
...
function createMockVisaApplication(overrides = {}) {
    return {
        id: 'visa-1',
...
function createMockEmergencyCase(overrides = {}) {
    return {
        id: 'ec-1',
...
function createMockDiplomaticPouch(overrides = {}) {
    return {
        id: 'dp-1',
...
function createMockWatchlistEntry(overrides = {}) {
    return {
        id: 'wl-1',
        fullName: 'John Doe',
...
function createMockVerificationCheck(overrides = {}) {
    return {
        id: 'vc-1',
