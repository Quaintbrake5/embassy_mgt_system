...
export class CreateUserDto {
  ...
  static validate(data: any): string[] {
    ...
    if (data.roleId !== undefined && data.roleId !== null && data.roleId !== '') {
      ...
      } else if (!validator.isUUID(data.roleId)) {
  ...
  static sanitize(data: any): CreateUserDto {
...
export class UpdateUserDto {
  ...
  static sanitize(data: any): UpdateUserDto {
    ...
    if (data.roleId !== undefined) dto.roleId = data.roleId?.trim();
